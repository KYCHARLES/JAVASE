...
public class Delivery {
    ...
    public Delivery(int id, String name, String username, String password, int status, int unfinishedOrder, int completedOrder, int cancelledOrder, int score, LocalDate createDate, LocalDate updateDate) {
        this.id = id;
        this.name = name;
